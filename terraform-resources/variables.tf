...
variable "vm_image_default_publisher" { type = string }
variable "vm_image_default_offer" { type = string }
variable "vm_image_default_sku" { type = string }
...
variable "vm_image_definition_offer" { type = string }
variable "vm_image_definition_sku" { type = string }
variable "vm_image_definition_publisher" { type = string }